...
export default function AboutPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-white flex flex-col font-sans selection:bg-orange-500 selection:text-white" dir={lang === 'ar' ? 'rtl' : 'ltr'}>
      ...
      {/* Main Content */}
      <main className="flex-1 max-w-4xl mx-auto px-6 py-16 sm:py-24 space-y-16 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 pt-8">
          <div className="bg-slate-900/40 border border-slate-900 p-8 rounded-2xl space-y-4">
        ...
        {/* Story Section */}
        <div className="bg-slate-900/20 border border-slate-900 p-8 rounded-2xl space-y-4">
          <h3 className="text-xl font-bold text-white flex items-center space-x-2 gap-2">
        ...
        <div className="space-y-6 pt-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {[t.val1, t.val2, t.val3, t.val4].map((v, i) => (
              <div key={i} className="flex items-center space-x-3 gap-3 bg-slate-900/30 border border-slate-900/80 p-4 rounded-xl">
                <span className="h-6 w-6 rounded-lg bg-orange-500/10 border border-orange-500/20 text-orange-500 flex items-center justify-center font-bold text-xs">
                  ✓
                </span>
