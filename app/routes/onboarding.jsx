...
export default function OnboardingPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-tr from-[#0F1524] via-slate-900 to-indigo-950 px-4 py-12 relative overflow-hidden text-white">
      {/* Background circles */}
      <div className="absolute top-1/4 right-1/4 w-96 h-96 bg-[#F97316]/10 rounded-full mix-blend-multiply filter blur-3xl opacity-10 animate-pulse pointer-events-none"></div>
      <div className="absolute bottom-1/4 left-1/4 w-96 h-96 bg-indigo-500/10 rounded-full mix-blend-multiply filter blur-3xl opacity-10 animate-pulse pointer-events-none" style={{ animationDelay: '2s' }}></div>

      <div className="w-full max-w-xl animate-slide-up z-10">
        <div className="text-center mb-8">
          <div className="h-12 w-12 mx-auto rounded-xl bg-gradient-to-tr from-[#F97316] to-amber-400 flex items-center justify-center shadow-lg shadow-[#F97316]/20 mb-3">
        ...
        <div className="bg-[#0F1524]/60 backdrop-blur-xl border border-slate-800 rounded-3xl p-8 shadow-2xl shadow-black/40">
          {errorMsg && (
          ...
          <form onSubmit={handleSaveOnboarding} className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="flex flex-col items-center p-4 bg-slate-950/30 border border-slate-800/80 rounded-2xl text-center">
                ...
                <label className="cursor-pointer inline-flex items-center space-x-1.5 border border-slate-800 hover:border-[#F97316] hover:text-[#F97316] bg-slate-950/30 text-slate-300 text-[11px] font-bold py-1.5 px-3 rounded-lg transition-all shadow-sm">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  className="w-full bg-[#0f172a]/50 border border-slate-800 rounded-xl px-4 py-3 text-white placeholder-slate-600 focus:outline-none focus:border-[#F97316] focus:ring-1 focus:ring-[#F97316] transition-all text-sm"
                />
              </div>
            ...
            {origin && slug && (
              <p className="text-[11px] text-slate-500 flex items-center space-x-1 px-1 -mt-3">
                ...
                <span className="text-[#F97316] font-semibold">{origin.replace(/^https?:\/\//, '')}/menu/{slug}</span>
              </p>
            )}
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full bg-[#0f172a]/50 border border-slate-800 rounded-xl pl-10 pr-4 py-3 text-white placeholder-slate-600 focus:outline-none focus:border-[#F97316] focus:ring-1 focus:ring-[#F97316] transition-all text-sm"
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="flex items-center space-x-3 bg-slate-950/50 border border-slate-800 rounded-xl px-3 py-1.5 h-[46px]">
                  <input
                    ...
                    className="h-7 w-12 border border-slate-800 rounded cursor-pointer bg-slate-955"
                  />
            ...
            <div>
              ...
              <div className="relative">
                ...
                <textarea
                  ...
                  className="w-full bg-[#0f172a]/50 border border-slate-800 rounded-xl pl-10 pr-4 py-3 text-white placeholder-slate-600 focus:outline-none focus:border-[#F97316] focus:ring-1 focus:ring-[#F97316] transition-all text-sm mb-4"
                />
              </div>
            </div>
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full bg-[#0f172a]/50 border border-slate-800 rounded-xl px-4 py-3 text-white placeholder-slate-600 focus:outline-none focus:border-[#F97316] focus:ring-1 focus:ring-[#F97316] transition-all text-sm resize-none"
              />
            </div>
            ...
            <button
              ...
              className="w-full bg-gradient-to-r from-[#F97316] to-amber-500 hover:from-[#F97316] hover:to-amber-600 text-white rounded-xl py-3 px-4 text-sm font-bold shadow-lg shadow-[#F97316]/10 hover:shadow-[#F97316]/20 active:scale-[0.98] transition-all flex items-center justify-center space-x-2 disabled:opacity-50 mt-2"
            >
              {saving ? (
                <>
