        ...
        <div className="bg-white border border-slate-200 rounded-2xl p-6 shadow-sm flex items-center justify-between">
          <div>
            ...
            <div className="flex items-baseline space-x-1.5 mt-1.5 gap-1.5">
              ...
              {averageRating && <span className="text-slate-400 text-[10px] font-bold">({totalReviews} reviews)</span>}
            </div>
          </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                return (
                  <div key={cat.name} className="space-y-1.5">
                    <div className="flex justify-between items-center text-[11px] font-bold">
                      ...
                      <span className="text-slate-500 shrink-0 font-sans">{cat.count} {cat.count === 1 ? 'item' : 'items'} ({percentage}%)</span>
                    </div>
        ...
        <div className="bg-white border border-slate-200 rounded-2xl p-6 shadow-sm space-y-4">
          ...
          <div className="space-y-3 pt-1.5">
            {totalReviews === 0 ? (
              <div className="text-center py-6 text-slate-450 text-xs font-semibold">No ratings received yet.</div>
            ) : (
