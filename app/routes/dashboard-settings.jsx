    ...
    <div className="space-y-6 pb-12 font-sans">
          ...
          <form onSubmit={handleSaveSettings} className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  className="w-full bg-slate-55 border border-slate-200 rounded-xl px-4 py-2.5 text-slate-805 focus:outline-none focus:border-orange-500 focus:ring-1 focus:ring-orange-500 transition-all text-sm"
                />
              </div>
              ...
              <div>
                ...
                <div className="relative flex items-center">
                  ...
                  <input
                    ...
                    className="w-full bg-slate-55 border border-slate-200 rounded-xl pl-16 pr-4 py-2.5 text-slate-805 focus:outline-none focus:border-orange-500 focus:ring-1 focus:ring-orange-500 transition-all text-sm"
                  />
                </div>
                {origin && slug && (
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full bg-slate-55 border border-slate-200 rounded-xl pl-10 pr-4 py-2.5 text-slate-805 focus:outline-none focus:border-orange-500 focus:ring-1 focus:ring-orange-500 transition-all text-sm"
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="flex items-center space-x-3 bg-slate-55 border border-slate-200 rounded-xl px-3 py-1.5 h-[41px]">
                  <input
                    type="color"
                    value={themeColor}
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full bg-slate-55 border border-slate-200 rounded-xl px-4 py-2.5 text-slate-850 focus:outline-none focus:border-orange-500 focus:ring-1 focus:ring-orange-500 transition-all text-sm h-[41px] appearance-none"
                >
            ...
            <div>
              ...
              <div className="relative">
                ...
                <textarea
                  ...
                  className="w-full bg-slate-55 border border-slate-200 rounded-xl pl-10 pr-4 py-2.5 text-slate-805 focus:outline-none focus:border-orange-500 focus:ring-1 focus:ring-orange-500 transition-all text-sm mb-4"
                />
              </div>
            </div>
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full bg-slate-55 border border-slate-200 rounded-xl px-4 py-2.5 text-slate-805 focus:outline-none focus:border-orange-500 focus:ring-1 focus:ring-orange-500 transition-all text-sm resize-none"
              />
            </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {[
                  ...
                  },
                  {
                    ...
                    accent: '#fbbf24',
                    preview: (
                      <div className="h-20 w-full rounded-lg bg-gradient-to-tr from-emerald-950 to-slate-905 p-2 flex flex-col justify-between border border-emerald-900">
                  ...
                  },
                  {
                    ...
                    accent: '#dc2626',
                    preview: (
                      <div className="h-20 w-full rounded-lg bg-gradient-to-tr from-amber-55 to-orange-50/20 p-2 flex flex-col justify-between border border-slate-300">
                  ...
                  },
                  {
                    ...
                    accent: '#f97316',
                    preview: (
                      <div className="h-20 w-full rounded-lg bg-slate-955 p-2 flex flex-col justify-between border border-slate-900">
                  ...
                  return (
                    <button
                      ...
                      className={`flex flex-col text-left p-4 rounded-2xl border transition-all relative overflow-hidden group cursor-pointer ${isSelected
                ...
                {[
                  ...
                  return (
                    <button
                      ...
                      className={`flex flex-col text-left p-3 rounded-2xl border transition-all relative overflow-hidden group cursor-pointer ${isSelected
                        ? 'border-orange-500 ring-2 ring-orange-500/10 bg-orange-50/5'
                        : 'border-slate-200 hover:border-slate-300 hover:bg-slate-50 bg-white'
                        }`}
                    >
                ...
                <div className="grid grid-cols-1 sm:grid-cols-4 gap-4 font-sans">
                  ...
                  <div>
                    ...
                    <div className="flex items-center space-x-2.5 bg-white border border-slate-200 rounded-xl px-2.5 py-1.5 h-[38px] shadow-sm">
                      ...
                      />
                      <span className="text-[10px] font-mono text-slate-605">
                        {colorBg.toUpperCase()}
                      </span>
                    </div>
                  </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div>
                        ...
                        <input
                          ...
                          className="w-full bg-white border border-slate-200 rounded-xl px-3 py-2 text-slate-805 focus:outline-none focus:border-orange-500 focus:ring-1 focus:ring-orange-500 transition-all text-xs"
                        />
                      </div>
                      ...
                      <div>
                        ...
                        <input
                          ...
                          className="w-full bg-white border border-slate-200 rounded-xl px-3 py-2 text-slate-805 focus:outline-none focus:border-orange-500 focus:ring-1 focus:ring-orange-500 transition-all text-xs text-right"
                          dir="rtl"
                        />
                      </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div>
                        ...
                        <select
                          ...
                          className="w-full bg-white border border-slate-200 rounded-xl px-3 py-2 text-slate-805 focus:outline-none focus:border-orange-500 focus:ring-1 focus:ring-orange-500 transition-all text-xs appearance-none"
                        >
                      ...
                      <div className="flex items-center justify-between pt-2">
                        <div>
                          <label className="text-xs font-bold text-slate-705 block">Scrolling Marquee Text</label>
            ...
            <button
              type="submit"
              disabled={saving}
              className="inline-flex items-center space-x-2 bg-gradient-to-r from-orange-500 to-amber-500 hover:from-orange-600 hover:to-amber-600 text-white rounded-xl py-3 px-6 text-sm font-bold shadow-lg shadow-orange-500/10 hover:shadow-orange-500/20 active:scale-[0.98] transition-all disabled:opacity-50 cursor-pointer"
            >
              {saving ? (
                <>
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white border border-slate-200 rounded-2xl shadow-sm p-6 flex flex-col items-center">
            ...
            <div className="mt-6 w-full text-center">
              <label className="cursor-pointer inline-flex items-center justify-center space-x-2 w-full border border-slate-200 hover:border-orange-500 hover:text-orange-500 bg-white text-slate-707 text-xs font-bold py-2.5 px-4 rounded-xl transition-all shadow-sm">
            ...
            <form onSubmit={handleSaveWifi} className="space-y-4">
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full bg-slate-55 border border-slate-200 rounded-xl px-4 py-2.5 text-slate-805 focus:outline-none focus:border-orange-500 focus:ring-1 focus:ring-orange-500 transition-all text-sm appearance-none"
                >
              ...
              <button
                type="submit"
                disabled={savingWifi}
                className="w-full inline-flex items-center justify-center space-x-2 border border-slate-200 hover:border-orange-500 hover:text-orange-500 bg-white text-slate-707 rounded-xl py-2.5 px-4 text-xs font-bold transition-all shadow-sm disabled:opacity-50 cursor-pointer"
              >
                {savingWifi ? (
                  <>
            ...
            <form onSubmit={handleChangePassword} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full bg-slate-55 border border-slate-200 rounded-xl px-4 py-2 text-slate-805 focus:outline-none focus:border-orange-500 focus:ring-1 focus:ring-orange-500 transition-all text-sm"
                />
              </div>
      ...
      <div className="fixed bottom-5 right-5 z-55 flex flex-col gap-3 max-w-sm w-full pointer-events-none">
        {toasts.map((toast) => (
          <div
            key={toast.id}
            className={`pointer-events-auto flex items-start justify-between p-4 rounded-xl border bg-white shadow-xl transition-all duration-300 animate-slide-up text-slate-808`}
          ...
          >
            ...
            <button
              ...
              className="text-slate-400 hover:text-slate-650 transition-colors ml-4 shrink-0"
            >
              <X className="h-4 w-4" />
            </button>
          </div>
