...
export default function BillingPortal({ profile, subscriptionInfo, isBlocker = false }) {
  ...
  const getPriceId = (planName) => {
    switch (planName.toLowerCase()) {
      case 'basic': return process.env.NEXT_PUBLIC_PADDLE_BASIC_PRICE_ID;
      case 'pro': return process.env.NEXT_PUBLIC_PADDLE_PRO_PRICE_ID;
      case 'premium': return process.env.NEXT_PUBLIC_PADDLE_PREMIUM_PRICE_ID;
      default: return null;
    }
  };
