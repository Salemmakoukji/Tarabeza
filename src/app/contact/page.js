...
import { ArrowLeft, Mail, Phone, MapPin, Send, Loader2, Sparkles } from 'lucide-react';
...
export default function ContactPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Try submitting to support_tickets in Supabase
      // Since this is a general inquiry, restaurant_id = null (make sure migration is run)
      const { error } = await supabase
        ...
        .insert({
          ...
          message: message,
          status: 'open',
          restaurant_id: null // Will work if column is nullable
        });
    ...
    <div className="min-h-screen bg-slate-950 text-white flex flex-col font-sans selection:bg-orange-500 selection:text-white" dir={lang === 'ar' ? 'rtl' : 'ltr'}>
      ...
      <main className="flex-1 max-w-6xl mx-auto px-6 py-16 sm:py-24 space-y-12 relative z-10 w-full">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 pt-8 items-stretch">
          ...
          {/* Left: Contact Info */}
          <div className="lg:col-span-4 bg-slate-900/40 border border-slate-900 p-8 rounded-2xl flex flex-col justify-between space-y-8">
          ...
          {/* Right: Message Form */}
          <div className="lg:col-span-8 bg-slate-900/40 border border-slate-900 p-8 rounded-2xl">
            ...
            <form onSubmit={handleSubmit} className="grid grid-cols-1 sm:grid-cols-2 gap-5">
              <div>
                ...
                <input
                  ...
                  className="w-full bg-slate-950/50 border border-slate-900 rounded-xl px-4 py-3 text-white placeholder-slate-700 focus:outline-none focus:border-orange-500 text-xs sm:text-sm"
                />
              </div>
              ...
              <div className="sm:col-span-2">
                ...
                <textarea
                  ...
                  className="w-full bg-slate-950/50 border border-slate-900 rounded-xl p-4.5 text-white placeholder-slate-700 focus:outline-none focus:border-orange-500 text-xs sm:text-sm"
                />
              </div>
