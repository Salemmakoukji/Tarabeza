          ...
          <div className="lg:col-span-3 space-y-4">
            ...
            {activeItems.length === 0 ? (
              <div className="bg-white border border-slate-200 rounded-2xl p-12 text-center flex flex-col items-center">
                ...
                <p className="text-slate-450 text-xs max-w-xs mb-4">Start showcasing your dishes by adding a menu item under &quot;{activeCategory?.name}&quot;.</p>
                <button
                  onClick={openAddItem}
                  ...
                  >
                    ...
                    <div className="p-4 flex-1 flex flex-col justify-between">
                      <div>
                        ...
                        {item.description && (
                          <p className="text-slate-505 text-xs leading-relaxed line-clamp-2 mb-3">
                            {item.description}
                          </p>
                        )}
